...
window.onload = function () {
    ...
    if (window.devicePixelRatio == 1)
        var game = new Phaser.Game(desktopWidth, desktopHeight, Phaser.CANVAS, 'game');
...
Main.prototype = {
    ...
    update: function() {
        ...
        // Scroll the top build order bar
    ...
    initUI: function() {
        ...
        line2.lineTo(/*-1000*/-__gameWidth + 323, 0);
        ...
        // Compress graphics into UI wireframe texture
        ...
        for (i = 0; i < this.timeIterations; i++) {
            ...
            var _time = _game.make.bitmapText(-85 + (i * 90), 122, 'Agency_35', timeString, 25);
            _timeGroup.add(_time);
            //var texture = _time.generateTexture();
            //var time = _game.make.image(-85 + (i * 90), 122, texture);
            //_time.destroy();
        ...
        var timeTextures = _timeGroup.generateTexture();
        this.timeImage = _game.add.image(0, 0, timeTextures);
    ...
    initTimeline: function() {
        ...
        this.timelineDrag = this.game.add.image(-18, 147, 'icon');
...
Preloader.prototype = {
	...
	preload: function() {
		...
		//this.load.bitmapFont('Agency_35', 'assets/fonts/agency_35_0.png', 'assets/fonts/agency_35.json' /*+ fileFormat*/);
		this.load.bitmapFont('Agency_35', 'assets/fonts/agency_35_0.png', 'assets/fonts/agency_35.xml' /*+ fileFormat*/);
		this.load.bitmapFont('Agency_15', 'assets/fonts/agency_15_num.png', 'assets/fonts/agency_15_num.xml' /*+ fileFormat*/);
